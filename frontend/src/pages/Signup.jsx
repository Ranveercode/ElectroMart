...
function SignupPage({ isAuthenticated, onSignup }) {
  ...
  const handleRegisterSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`https://electro-mart-qalg.vercel.app/api/auth/register`, {
        method: "POST",
        headers: {
  ...
  const handleVerifySubmit = async (e) => {
    ...
    try {
      const response = await fetch(`https://electro-mart-qalg.vercel.app/api/auth/verify`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
